...
void create()
{
	...
	// 技能英文
	set("id",		"metalclassify");

	// 技能頭銜
	set("title/40",		HIW"金屬分類員"NOR);
	set("title/100",	HIW"金屬分類師"NOR);
	
	// 技能註解
	set("note",		"金屬工業分類技術(需金屬採集Lv80)");
}
...
varargs int allowable_learn(object ob)
{
	...
	else
	{
		...
		{
			if( ob->query_skill_level("metal") < 80 )
				return 0;
			else
				return 1;
		}
