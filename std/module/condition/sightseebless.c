...
#define CONDITION_ID		"sightseebless"
#define CONDITION_NAME		HIC"生活"NOR CYN"視野"NOR
...
{
	set("condition/"+replace_string(base_name(this_object()), "/","#")+"/"+BUFF_INT, 2, ob);
	set("condition/"+replace_string(base_name(this_object()), "/","#")+"/"+BUFF_CHA, 2, ob);
